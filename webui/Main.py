...
def _render_generation_controls(
    ...
    st.checkbox(
        tr("Generate both Hindi and English"),
        key="generate_hi_en_pair",
        help=tr("Generate both Hindi and English Help"),
    )
    ...
    if start_button:
        ...
        try:
            ...
            if st.session_state.get("generate_hi_en_pair"):
                hi_task_id = webui_task.submit_bilingual_generation(
                    task_id=task_id,
                    params=params,
                ...
                if hi_task_id:
                    _add_active_generation_task(
                        hi_task_id,
                        subject=(
                            params.video_subject or params.video_script or hi_task_id
                        ),
                    )
            else:
